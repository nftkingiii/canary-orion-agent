      ...
      <main>
        {activeTab === 'overview' && <section className="overview-screen" role="tabpanel">
          ...
          <div className="authority-stage" aria-live="polite">
            ...
            <div className="stage-bottom"><div><strong>{formatUsd(activeMandate.capitalUsd)}</strong><span>capital protected</span></div><div><strong>{strategyAgents.length}</strong><span>candidate agents</span></div><div><strong>{report?.safety.unsafeExecuted ?? 0}</strong><span>unsafe executions</span></div></div>
          </div>
