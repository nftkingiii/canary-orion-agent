...
| Product-only workflow | User-supplied endpoint → saved policy → six live decisions → inspectable report; no public fixtures, winner, authority or forced revocation | `src/App.tsx`, single-agent report regression test | Implemented locally, 2026-08-26; public verification pending |
